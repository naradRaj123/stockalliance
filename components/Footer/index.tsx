  ...
  return (
    <>
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="max-w-c-200 mx-auto px-4 md:px-8 2xl:px-0">
          {/* <!-- Footer Top --> */}
          <div className="py-20 lg:py-5">
            <div className="flex-row flex-wrap  lg:justify-between lg:gap-0">
              <motion.div
                variants={{
                  hidden: {
                    opacity: 0,
              ...
              >
                ...
                <a href="mailto:contact@stockalliance.in">
                  contact@stockalliance.in
                </a>
              </motion.div>
            </div>
          </div>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Stock Alliance. All rights
                reserved
              </p>
            </motion.div>
            ...
            >
              <ul className="flex items-center gap-5">
                <li>
                  <a
                    href="https://www.facebook.com/Stock Alliance/"
                ...
                <li>
                  <a
                    href="https://x.com/Stock Alliance_/"
                    aria-label="social icon"
                  >
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                ...
                <li>
                  {/*LinkedIn*/}
                  <a
                    href="https://www.linkedin.com/company/Stock Alliance"
                    aria-label="social icon"
                  >
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
